...
class AppTypography {
  ...
  static TextStyle displayLarge(BuildContext context) => TextStyle(
    fontSize: _scale(context, 57, 1.0),
  ...
  static TextStyle displayMedium(BuildContext context) => TextStyle(
    fontSize: _scale(context, 45, 1.0),
  ...
  static TextStyle displaySmall(BuildContext context) => TextStyle(
    fontSize: _scale(context, 36, 1.0),
    fontWeight: FontWeight.w700,
    height: 1.22,
    letterSpacing: 0,
  );
  ...
  static TextStyle headlineLarge(BuildContext context) => TextStyle(
    fontSize: _scale(context, 32, 1.0),
  ...
  static TextStyle headlineMedium(BuildContext context) => TextStyle(
    fontSize: _scale(context, 28, 1.0),
    fontWeight: FontWeight.w600,
    height: 1.29,
    letterSpacing: 0,
  );
  ...
  static TextStyle headlineSmall(BuildContext context) => TextStyle(
    fontSize: _scale(context, 24, 1.0),
    fontWeight: FontWeight.w600,
    height: 1.33,
    letterSpacing: 0,
  );
  ...
  static TextStyle titleLarge(BuildContext context) => TextStyle(
    fontSize: _scale(context, 22, 1.0),
  ...
  static TextStyle titleMedium(BuildContext context) => TextStyle(
    fontSize: _scale(context, 16, 1.0),
  ...
  static TextStyle titleSmall(BuildContext context) => TextStyle(
    fontSize: _scale(context, 14, 1.0),
    fontWeight: FontWeight.w500,
    height: 1.43,
    letterSpacing: 0.1,
  );
  ...
  static TextStyle bodySmall(BuildContext context) => TextStyle(
    fontSize: _scale(context, 12, 1.0),
    fontWeight: FontWeight.w400,
    height: 1.33,
    letterSpacing: 0.4,
  );
  ...
  static TextStyle labelSmall(BuildContext context) => TextStyle(
    fontSize: _scale(context, 11, 1.0),
    fontWeight: FontWeight.w500,
    height: 1.45,
    letterSpacing: 0.5,
  );
  ...
  static TextStyle timeDisplay(BuildContext context) => TextStyle(
    fontSize: _scale(context, 48, 1.0),
    fontWeight: FontWeight.w400,
    height: 1.25,
    letterSpacing: 0.5,
  );
